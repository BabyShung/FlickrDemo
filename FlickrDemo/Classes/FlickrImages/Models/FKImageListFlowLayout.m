...
@interface FKImageListFlowLayout()

@property (nonatomic, weak) id<FKImageListFlowLayoutDelegate> delegate;
...
@implementation FKImageListFlowLayout
...
- (id<FKImageListFlowLayoutDelegate>)delegate
{
    if (_delegate == nil) {
        _delegate =  (id<FKImageListFlowLayoutDelegate>)self.collectionView.delegate;
    }
